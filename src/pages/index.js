            ...
            <div class="container-medium">  
              <div class="padding-section-large">
                <div class="newsletter-section_max-width">
                  ...
                  <h3 class="heading-style-h4"><a href="https://twitter.com/0xantofy" target="_blank"><span className="white-text">subscribe to Twitter</span><span class="newsletter_link-icon" /></a></h3>
                </div>
              </div>
            </div>
          </div>
